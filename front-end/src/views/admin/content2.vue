        ...
        <el-dialog v-model="dialogFormVisible" title="学生信息修改" :modal="false" z-index:999 :append-to-body="true">
            <el-form>
                <el-form ref="ruleFormRef" :model="form" :rules="rule" label-width="120px"  status-icon >
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="submitForm(ruleFormRef),dialogFormVisible=false">
                            确认修改
                        </el-button>
                    </el-form-item>
                </el-form>
...
const getInfo=()=>{
    axios.get("/admin/getTeacherInfo?currentPage="+currentPage.value,{headers:axios2.accessHeader()})
        .then((res)=>{
            console.log(res)
